...
const config = {
  ...
  resolve: {
    ...
    alias: {
      '@fontsource/inter': path.resolve(APP_DIR, 'node_modules/@fontsource/inter'),
      'antd/lib/locale': path.resolve(APP_DIR, 'node_modules/antd/es/locale'),
  ...
  module: {
    rules: [
      ...
      {
        test: /node_modules\/(geostyler|ol|geostyler-openlayers-parser|geostyler-mapbox-parser|geostyler-sld-parser)\/.*\.js$/,
        resolve: {
          fullySpecified: false,
        },
      },
